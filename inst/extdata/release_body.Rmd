...
## License
The *graph.obj* and *network.dat* graph files are made available under the [ODbL v1.0](https://opendatacommons.org/licenses/odbl/1-0/).
...
- [TravelWhiz GTFS data](github.com/travelwhiz-ltd/GB-Bus-Train-Metro-GTFS) from TravelWhiz under the [CC-BY v4.0](https://creativecommons.org/licenses/by/4.0/uk/legalcode).

TravelWhiz's data is in turn derived from:
